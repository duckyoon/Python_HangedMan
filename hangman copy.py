...
no_font = pygame.font.Font("C:/Windows/Fonts/ALGER.TTF", 40)
title_font = pygame.font.Font("C:/Windows/Fonts/ALGER.TTF", 80)
guide_font = pygame.font.Font("C:/Windows/Fonts/ALGER.TTF", 20)
finish_font = pygame.font.Font("C:/Windows/Fonts/ALGER.TTF", 30)
...
while not exit:
    ...
    while not exit:
        ...
        if game_over == True:
            ...
            finish_bg.set_alpha(200) # 투명도 설정
